-- Migration: Update handle_storage_upload for reciliacion
-- Date: 2026-02-11
-- Description: Updates the storage trigger to handle reciliacion documents and removes 'fase' from insertion as it was dropped from OCR tables.
...
BEGIN
  ...
  -- 3. Insert into OCR table (Removed 'fase' as it was dropped in migration 080)
